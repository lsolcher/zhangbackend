		...
		<div class="main group">
			...
			<table class="result-table">
				...
				<tbody>
					...
					<tr>
						<td>08:00-09:30</td>
						<td id="table-cell-00"></td>
						<td id="table-cell-01"></td>
						<td id="table-cell-02"></td>
						<td id="table-cell-03"></td>
						<td id="table-cell-04"></td>
						<td id="table-cell-05"></td>
						<td id="table-cell-06"></td>
						<td id="table-cell-07"></td>
						<td id="table-cell-08"></td>
						<td id="table-cell-09"></td>
					</tr>
					<tr>
						<td>09:45-11:15</td>
